...
#define PLUGIN_ID "44E0D26B-DEB6-4F9C-823E-FCBE3A240C58"
...
MetadataImporterPluginType *AllocMetadataImporterPluginType(CFUUIDRef inFactoryID)
{
    ...
    theNewInstance = (MetadataImporterPluginType *)calloc(1, sizeof(MetadataImporterPluginType));
...
// -----------------------------------------------------------------------------
//	DeallocCHiWorkSpotlightPluginMDImporterPluginType
// -----------------------------------------------------------------------------
...
void DeallocMetadataImporterPluginType(MetadataImporterPluginType *thisInstance)
{
    ...
    /*openlog("LaTeXiT/CHiWorkSpotlightPlugin", 0, LOG_USER);
    syslog(LOG_ERR, "will closelog");
    closelog();*/
}
...
// -----------------------------------------------------------------------------
//	CHiWorkSpotlightPluginMDImporterPluginFactory
// -----------------------------------------------------------------------------
