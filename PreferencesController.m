...
-(BOOL) doNotClipPreview
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    number = (__bridge_transfer NSNumber*)CFPreferencesCopyAppValue((__bridge CFStringRef)DefaultDoNotClipPreviewKey, (__bridge CFStringRef)LaTeXiTAppKey);
    #else
...
-(NSUInteger) editionTabKeyInsertsSpacesCount
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    result = [(__bridge_transfer NSNumber*)CFPreferencesCopyAppValue((__bridge CFStringRef)EditionTabKeyInsertsSpacesCountKey, (__bridge CFStringRef)LaTeXiTAppKey) unsignedIntValue];
    #else
...
-(BOOL) historySaveServicesResultsEnabled
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    result = [(__bridge_transfer NSNumber*)CFPreferencesCopyAppValue((__bridge CFStringRef)ServiceUsesHistoryKey, (__bridge CFStringRef)LaTeXiTAppKey) boolValue];
    #else
...
-(BOOL) historyDeleteOldEntriesEnabled
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    result = [(__bridge_transfer NSNumber*)CFPreferencesCopyAppValue((__bridge CFStringRef)HistoryDeleteOldEntriesEnabledKey, (__bridge CFStringRef)LaTeXiTAppKey) boolValue];
    #else
...
-(BOOL) historySmartEnabled
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    result = [(__bridge_transfer NSNumber*)CFPreferencesCopyAppValue((__bridge CFStringRef)HistorySmartEnabledKey, (__bridge CFStringRef)LaTeXiTAppKey) boolValue];
    #else
...
-(CGFloat) marginsAdditionalLeft
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    result = [(__bridge_transfer NSNumber*)CFPreferencesCopyAppValue((__bridge CFStringRef)AdditionalLeftMarginKey, (__bridge CFStringRef)LaTeXiTAppKey) floatValue];
    #else
...
-(CGFloat) marginsAdditionalRight
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    result = [(__bridge_transfer NSNumber*)CFPreferencesCopyAppValue((__bridge CFStringRef)AdditionalRightMarginKey, (__bridge CFStringRef)LaTeXiTAppKey) floatValue];
    #else
...
-(CGFloat) marginsAdditionalTop
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    result = [(__bridge_transfer NSNumber*)CFPreferencesCopyAppValue((__bridge CFStringRef)AdditionalTopMarginKey, (__bridge CFStringRef)LaTeXiTAppKey) floatValue];
    #else
...
-(CGFloat) marginsAdditionalBottom
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    result = [(__bridge_transfer NSNumber*)CFPreferencesCopyAppValue((__bridge CFStringRef)AdditionalBottomMarginKey, (__bridge CFStringRef)LaTeXiTAppKey) floatValue];
    #else
...
-(BOOL) synchronizationNewDocumentsEnabled
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    result = [(__bridge_transfer NSNumber*)CFPreferencesCopyAppValue((__bridge CFStringRef)SynchronizationNewDocumentsEnabledKey, (__bridge CFStringRef)LaTeXiTAppKey) boolValue];
    #else
...
-(BOOL) synchronizationNewDocumentsSynchronizePreamble
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    [(__bridge_transfer NSNumber*)CFPreferencesCopyAppValue((__bridge CFStringRef)SynchronizationNewDocumentsSynchronizePreambleKey, (__bridge CFStringRef)LaTeXiTAppKey) boolValue];
    #else
...
-(BOOL) synchronizationNewDocumentsSynchronizeEnvironment
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    result = [(__bridge_transfer NSNumber*)CFPreferencesCopyAppValue((__bridge CFStringRef)SynchronizationNewDocumentsSynchronizeEnvironmentKey, (__bridge CFStringRef)LaTeXiTAppKey) boolValue];
    #else
...
-(BOOL) synchronizationNewDocumentsSynchronizeBody
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    result = [(__bridge_transfer NSNumber*)CFPreferencesCopyAppValue((__bridge CFStringRef)SynchronizationNewDocumentsSynchronizeBodyKey, (__bridge CFStringRef)LaTeXiTAppKey) boolValue];
    #else
...
-(NSString*) synchronizationNewDocumentsPath
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    result = (__bridge_transfer NSString*)CFPreferencesCopyAppValue((__bridge CFStringRef)SynchronizationNewDocumentsPathKey, (__bridge CFStringRef)LaTeXiTAppKey);
    #else
...
-(SynchronizationAdditionalScriptsController*) lazySynchronizationAdditionalScriptsControllerWithCreationIfNeeded:(BOOL)creationOptionIfNeeded
{
  ...
  if (!self->synchronizationAdditionalScriptsController && creationOptionIfNeeded)
  {
    ...
    {
      #ifdef ARC_ENABLED
      NSDictionary* synchronizationAdditionalScripts = (__bridge_transfer NSDictionary*)CFPreferencesCopyAppValue((__bridge CFStringRef)SynchronizationAdditionalScriptsKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(NSDictionary*) synchronizationAdditionalScriptsFromControllerIfPossible:(BOOL)fromControllerIfPossible createControllerIfNeeded:(BOOL)createControllerIfNeeded
{
  ...
  if (!result)
  {
    if (self->isLaTeXiT)
      ...
      #ifdef ARC_ENABLED
      result = (__bridge_transfer NSDictionary*)CFPreferencesCopyAppValue((__bridge CFStringRef)SynchronizationAdditionalScriptsKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(NSString*) libraryPath
{
  ...
  if (self->isLaTeXiT)
    ...
    #ifdef ARC_ENABLED
    result = (__bridge_transfer NSString*)CFPreferencesCopyAppValue((__bridge CFStringRef)LibraryPathKey, (__bridge CFStringRef)LaTeXiTAppKey);
    #else
...
-(NSArrayController*) lazyEditionTextShortcutsControllerWithCreationIfNeeded:(BOOL)creationOptionIfNeeded
{
  ...
  if (!self->editionTextShortcutsController && creationOptionIfNeeded)
  {
    ...
    {
      #ifdef ARC_ENABLED
      NSArray* editionTextShortcuts = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)TextShortcutsKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(NSArray*) editionTextShortcutsFromControllerIfPossible:(BOOL)fromControllerIfPossible createControllerIfNeeded:(BOOL)createControllerIfNeeded
{
  ...
  if (!result)
  {
    if (self->isLaTeXiT)
      ...
      #ifdef ARC_ENABLED
      result = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)TextShortcutsKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(PreamblesController*) lazyPreamblesControllerWithCreationIfNeeded:(BOOL)creationOptionIfNeeded
{
  ...
  if (!self->preamblesController && creationOptionIfNeeded)
  {
    ...
    {
      #ifdef ARC_ENABLED
      NSArray* preambles =(__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)PreamblesKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(NSArray*) preamblesFromControllerIfPossible:(BOOL)fromControllerIfPossible createControllerIfNeeded:(BOOL)createControllerIfNeeded
{
  ...
  if (!result)
  {
    if (self->isLaTeXiT)
      ...
      #ifdef ARC_ENABLED
      result = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)PreamblesKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(BodyTemplatesController*) lazyBodyTemplatesControllerWithCreationIfNeeded:(BOOL)creationOptionIfNeeded
{
  ...
  if (!self->bodyTemplatesController && creationOptionIfNeeded)
  {
    ...
    {
      #ifdef ARC_ENABLED
      NSArray* bodyTemplates = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)BodyTemplatesKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(NSArray*) bodyTemplatesFromControllerIfPossible:(BOOL)fromControllerIfPossible createControllerIfNeeded:(BOOL)createControllerIfNeeded
{
  ...
  if (!result)
  {
    if (self->isLaTeXiT)
      ...
      #ifdef ARC_ENABLED
      result = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)BodyTemplatesKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(CompositionConfigurationsController*) lazyCompositionConfigurationsControllerWithCreationIfNeeded:(BOOL)creationOptionIfNeeded
{
  ...
  if (!self->compositionConfigurationsController && creationOptionIfNeeded)
  {
    ...
    {
      #ifdef ARC_ENABLED
      NSArray* compositionConfigurations = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)CompositionConfigurationsKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(NSArray*) compositionConfigurationsFromControllerIfPossible:(BOOL)fromControllerIfPossible createControllerIfNeeded:(BOOL)createControllerIfNeeded
{
  ...
  if (!result)
  {
    if (self->isLaTeXiT)
      ...
      #ifdef ARC_ENABLED
      result = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)CompositionConfigurationsKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(NSArrayController*) lazyServiceShortcutsControllerWithCreationIfNeeded:(BOOL)creationOptionIfNeeded
{
  ...
  if (!self->serviceShortcutsController && creationOptionIfNeeded)
  {
    ...
    {
      #ifdef ARC_ENABLED
      NSArray* serviceShortcuts = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)ServiceShortcutsKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(NSArray*) serviceShortcutsFromControllerIfPossible:(BOOL)fromControllerIfPossible createControllerIfNeeded:(BOOL)createControllerIfNeeded
{
  ...
  if (!result)
  {
    if (self->isLaTeXiT)
      ...
      #ifdef ARC_ENABLED
      result = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)ServiceShortcutsKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(ServiceRegularExpressionFiltersController*) lazyServiceRegularExpressionFiltersControllerWithCreationIfNeeded:(BOOL)creationOptionIfNeeded
{
  ...
  if (!self->serviceRegularExpressionFiltersController && creationOptionIfNeeded)
  {
    ...
    {
      #ifdef ARC_ENABLED
      NSArray* serviceRegularExpressionFilters = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)ServiceRegularExpressionFiltersKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(NSArray*) serviceRegularExpressionFiltersFromControllerIfPossible:(BOOL)fromControllerIfPossible createControllerIfNeeded:(BOOL)createControllerIfNeeded
{
  ...
  if (!result)
  {
    if (self->isLaTeXiT)
      ...
      #ifdef ARC_ENABLED
      result = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)ServiceRegularExpressionFiltersKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(AdditionalFilesController*) lazyAdditionalFilesControllerWithCreationIfNeeded:(BOOL)creationOptionIfNeeded
{
  ...
  if (!self->additionalFilesController && creationOptionIfNeeded)
  {
    ...
    {
      #ifdef ARC_ENABLED
      NSArray* additionalFilesPaths = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)AdditionalFilesPathsKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(NSArray*) additionalFilesPathsFromControllerIfPossible:(BOOL)fromControllerIfPossible createControllerIfNeeded:(BOOL)createControllerIfNeeded
{
  ...
  if (!result)
  {
    if (self->isLaTeXiT)
      ...
      #ifdef ARC_ENABLED
      result = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)AdditionalFilesPathsKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
...
-(EncapsulationsController*) lazyEncapsulationsControllerWithCreationIfNeeded:(BOOL)creationOptionIfNeeded
{
  ...
  if (!self->encapsulationsController && creationOptionIfNeeded)
  {
    ...
    {
      #ifdef ARC_ENABLED
      NSArray* encapsulations = (__bridge_transfer NSArray*)CFPreferencesCopyAppValue((__bridge CFStringRef)EncapsulationsKey, (__bridge CFStringRef)LaTeXiTAppKey);
      #else
