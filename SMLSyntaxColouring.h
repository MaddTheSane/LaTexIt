...
@interface SMLSyntaxColouring : NSObject {
	...
	unsigned int currentYOfSelectedCharacter;
	unsigned int lastYOfSelectedCharacter;
	unsigned int currentYOfLastCharacterInLine;
	unsigned int lastYOfLastCharacterInLine;
	unsigned int currentYOfLastCharacter;
	unsigned int lastYOfLastCharacter;
	unsigned int lastCursorLocation;
	...
	unsigned int skipEndCommand;
	unsigned int beginLocationInMultiLine;
	unsigned int endLocationInMultiLine;
	unsigned int searchSyntaxLength;
	...
	int differenceBetweenLastAndPresent;
	unsigned short skipMatchingBrace;
	NSRect visibleRect;
	NSRange visibleRange;
	unsigned int beginningOfFirstVisibleLine;
	unsigned int endOfLastVisibleLine;
