...
CGBlendColorsRef CGBlendColorsCreate(CGColorRef _Nonnull colors[_Nonnull], NSUInteger nbColors, blendFunction_t blendFunction, CFNumberRef __nullable blendFunctionParameter);
