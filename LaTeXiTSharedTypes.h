...
typedef enum {SYNCHRONIZATION_SCRIPT_PLACE_LOADING_PREPROCESSING, SYNCHRONIZATION_SCRIPT_PLACE_LOADING_POSTPROCESSING,
              SYNCHRONIZATION_SCRIPT_PLACE_SAVING_PREPROCESSING, SYNCHRONIZATION_SCRIPT_PLACE_SAVING_POSTPROCESSING} synchronization_script_place_t;

typedef enum {DOCUMENT_STYLE_UNDEFINED=-1, DOCUMENT_STYLE_NORMAL=0, DOCUMENT_STYLE_MINI=1} document_style_t;

typedef enum {LIBRARY_ROW_IMAGE_AND_TEXT, LIBRARY_ROW_IMAGE_LARGE, LIBRARY_ROW_IMAGE_ADJUST} library_row_t;
